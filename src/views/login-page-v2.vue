		...
		<div class="card loginCard m-3" id="loginCard">
			<div class="card-body p-4">
				...
				<liquido-input
					...
					@keypress.enter="continueWithEmail"
					:required="true"
					:label="$t('Email')"
					tabindex="1" />
				...
				<button
					...
					:disabled="emailInputState !== STATE.VALID || checking"
				...
				<div v-show="step === 2">
					...
					<button
						...
						:disabled="passwordInputState !== STATE.VALID"
...
export default {
	...
	methods: {
		...
		async continueWithEmail() {
			if (this.emailInputState !== STATE.VALID || this.checking) return
			this.emailNotFound = false
		...
		loginWithEmailPassword() {
			if (this.passwordInputState !== STATE.VALID) return
			this.loginErrorMessage = null
